    ...
    <>
      ...
      <div className="mt-6 flex flex-wrap items-baseline justify-between gap-3">
        ...
        <span className="text-[11px]" style={{ color: 'var(--ink-muted)' }}>
          Her taksit kartın kesim gününde deftere Gider olarak yazılır. Kutuya tıkla, tablo süzülsün.
        </span>
      </div>
      <div className="mt-2">
        <TaksitAkisi bekleyen={bekleyen} yansiyan={yansiyan} bugun={gunBugun} />
      </div>
    </>
  )
}
